...
/// <summary>
///     Demonstrates testing C# System.Numerics.Vector3 objects with good vs bad assertion patterns.
...
///     Note: These tests use System.Numerics.Vector3 instead of Godot.Vector3.
/// </summary>
[TestSuite]
public class CSharpVectorTests
{
    /// <summary>
    ///     Tests System.Numerics.Vector3 constants and basic equality comparisons.
    ...
    public void Vector3ComparisonsConstants()
    {
        ...
        AssertThat(new Vector3(0, 1, 0)).IsEqual(Vector3.UnitY);
    }

    /// <summary>
    ///     ❌ BAD APPROACH: Testing System.Numerics.Vector3 by checking individual components (X, Y, Z) separately.
    ...
    /// <summary>
    ///     ✅ GOOD APPROACH: Testing System.Numerics.Vector3 using direct comparison with expected values.
